...
<?php if ( comments_open() ) : ?>
  <div id="respond">
    ...
    <?php else : ?>
      <form id="commentform" method="POST" action="<?php echo esc_url( home_url() ); ?>/wp-comments-post.php">
        <?php if ( is_user_logged_in() ) : ?>
          <p>Logged in as
            <a href="<?php echo esc_url( home_url( '/' ) ); ?>wp-admin/profile.php"><?php echo $user_identity; ?></a>.
